...
export function reseedDocuments(db: Database.Database): void {
  ...
  ups.run(102, 'Driver Onboarding Checklist', 'SOP', [
    ...
    'Scan or photograph both sides.',
    '- Not expired',
    '- Correct class: Class A for semi-trucks',
  ...
  ups.run(105, 'Driver Safety Compliance', 'Policy', [
    ...
    '',
    '### 1. Valid CDL',
    '- Class A required for semi-trucks pulling trailers',
    '- Not expired -- check OnTrack driver profile',
  ...
  ups.run(106, 'Facebook Driver Search SOP', 'SOP', [
    ...
    '',
    '## Overview',
    'Facebook is the single best free channel for finding owner-operator drivers. Tens of thousands of CDL drivers are active in trucking groups daily. This SOP covers the systematic daily process to find, contact, and convert drivers into dispatch clients.',
    '',
  ...
  ups.run(120, 'New Driver Pitch - Converting Leads to Signed', 'SOP', [
    ...
    '- What equipment do they run? (can you find loads for this type?)',
  ...
  ups.run(122, 'Signed Driver Onboarding Workflow', 'SOP', [
    ...
    '3. Set truck type, trailer type, home base, preferred lanes, minimum RPM.',
    '4. Set dispatch percentage (default 7%).',
    '5. Enter CDL expiry and insurance expiry dates.',
    ...
    '- Day 1-2: verify authority, create driver record in OnTrack',
